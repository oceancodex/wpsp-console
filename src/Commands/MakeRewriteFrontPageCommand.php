...
class MakeRewriteFrontPageCommand extends Command {
	...
	protected function execute(InputInterface $input, OutputInterface $output): int {
		...
		// Check exist.
		$exist = FileSystem::exists($this->mainPath . '/app/Extends/Components/RewriteFrontPages/' . $nameSlugify . '.php');
		...
		FileSystem::put($this->mainPath . '/app/Extends/Components/RewriteFrontPages/' . $nameSlugify . '.php', $content);
