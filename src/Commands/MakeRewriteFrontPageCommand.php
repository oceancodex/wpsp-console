...
class MakeRewriteFrontPageCommand extends Command {
	...
	protected function configure(): void {
		$this
			...
			->setDescription('Create a new rewrite front page.          | Eg: bin/wpsp make:rewrite-front-page custom-rewrite-front-page --rewrite-page-slug=parent/rewrite-front-pages --use-template')
