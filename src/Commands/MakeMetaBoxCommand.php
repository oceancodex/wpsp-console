...
class MakeMetaBoxCommand extends Command {
	...
	protected function execute(InputInterface $input, OutputInterface $output): int {
		...
		// Check exist.
		$exist = FileSystem::exists($this->mainPath . '/app/Extends/Components/MetaBoxes/' . $idSlugify . '.php');
//		$exist = $exist || FileSystem::exists(__DIR__ . '/../../../resources/views/modules/meta-boxes/'. $id . '.blade.php');
		...
		FileSystem::put($this->mainPath . '/app/Extends/Components/MetaBoxes/' . $idSlugify . '.php', $content);
