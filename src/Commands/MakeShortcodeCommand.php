...
class MakeShortcodeCommand extends Command {
	...
	protected function execute(InputInterface $input, OutputInterface $output): int {
		...
		// Check exist.
		$exist = FileSystem::exists($this->mainPath . '/app/Extends/Components/Shortcodes/' . $nameSlugify . '.php');
		if ($exist) {
		...
		FileSystem::put($this->mainPath . '/app/Extends/Components/Shortcodes/' . $nameSlugify . '.php', $content);
